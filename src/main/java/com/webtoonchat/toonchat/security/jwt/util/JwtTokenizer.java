package com.webtoonchat.toonchat.security.jwt.util;
...
public class JwtTokenizer {
	...
	public static final Long ACCESS_TOKEN_EXPIRE_COUNT = 30 * 60 * 1000L; // 30 minutes
	public static final Long REFRESH_TOKEN_EXPIRE_COUNT = 7 * 24 * 60 * 60 * 1000L; // 7 days

	public JwtTokenizer(
			@Value("${jwt.secretKey}") String accessSecret, @Value("${jwt.refreshKey}") String refreshSecret
	) {
