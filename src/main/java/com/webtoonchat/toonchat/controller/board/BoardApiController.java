...
public class BoardApiController {
	...
	public ResponseEntity<Board> addBoard(
			@PathVariable String bgno, @RequestBody AddBoardRequest request, HttpServletRequest httpServletRequest) {
		Claims claims = extracted(httpServletRequest);
		Integer userid = (Integer) claims.get("userId");
		Board savedArticle = boardService.save(request, bgno, userid);
	...
	public ResponseEntity<List<BoardResponse>> findAllBoards(
			@PathVariable String bgno, HttpServletRequest httpServletRequest) {
	...
	public ResponseEntity<BoardResponse> findBoard(
			@PathVariable String bgno, @PathVariable long id, HttpServletRequest httpServletRequest) {
